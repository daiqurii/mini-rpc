package com.dzx.myrpc.client.handler;

import com.dzx.myrpc.server.request.ServiceInvokeRequest;
import com.dzx.myrpc.server.service.impl.StudentServiceImpl;
...
public class RpcObjectClientHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ...
        Class c = StudentServiceImpl.class;
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        // 在这里接收到服务端的响应结果
        System.out.println("收到了返回信息："+msg);
        ctx.close();
    }
